...
import { insertTestDimensions, mdClients } from '@cube-creator/testing/lib'
...
const ns = namespace('https://cube-creator.lndo.site/managed-dimensions/')

describe('@cube-creator/managed-dimensions-api/lib/domain/resource @SPARQL', () => {
